...
#define BOX_ONE_PIN D6
#define BOX_TWO_PIN D7
...
//       Serial.println(digitalRead(BOX_ONE_PIN));
//       Serial.print("pin 1 value == ");
//       Serial.println(digitalRead(BOX_TWO_PIN));
//       Serial.println("----------------------");
       
       
     if (digitalRead(BOX_ONE_PIN)==LOW) {
    ...
    if (digitalRead(BOX_TWO_PIN)== LOW) {
